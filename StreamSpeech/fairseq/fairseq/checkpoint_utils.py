...
def load_checkpoint(cfg: CheckpointConfig, trainer, **passthrough_args):
    ...
    *passthrough_args* will be passed through to
    ...
    suffix = trainer.checkpoint_suffix
    load_partial = trainer.cfg.checkpoint.load_partial
    trainer.cfg.checkpoint.load_partial = None
    if (
        ...
        if first_launch and getattr(cfg, "continue_once", None) is not None:
            ...
            if PathManager.exists(cfg.finetune_from_model):
                ...
                trainer.cfg.checkpoint.load_partial = load_partial # only first laucn we drop parameter irger wise just load last checkooints
            else:
                raise ValueError(
    ...
    if extra_state is not None and not reset_dataloader:
        ...
        print("load checkpoints dataset..........")
        epoch_itr = trainer.get_train_iterator(
