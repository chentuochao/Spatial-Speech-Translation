...
def check_for_nan(tensor, info):
    if torch.isnan(tensor).any():
        print(f"{info} nan detected ")
...
class StreamSpeechModel(ChunkS2UTConformerModel):
    ...
    def add_args(parser):
        ...
        parser.add_argument(
            ...
            type=int,
            default=None,
            help="unit decoder internal dim",
        )
        # parser.add_argument(
        #     "--unit-output-dim",
        #     type=int,
        #     default=None,
        #     help="unit decoder otuput dim",
        # )
    @classmethod
    ...
    def build_decoder(cls, args, tgt_dict, aug_attn=False):
        ...
        if getattr(args, "unit_decoder_dim", None) is not None:
            _args.decoder_embed_dim = args.unit_decoder_dim
            _args.decoder_output_dim = args.unit_decoder_dim
        # if args.unit_output_dim is not None:
        #     _args.decoder_output_dim = args.unit_output_dim
    ...
    def build_model(cls, args, task):
        ...
        # print("*****DEBUG StreamSpeech/researches/ctc_unity/models/streamspeech_model.py line 185", encoder)
        ...
        # print("*****DEBUG StreamSpeech/researches/ctc_unity/models/streamspeech_model.py", task.multitask_tasks)
    ...
    def forward(
        ...
        # 3. T2U decoder
        if self.t2u_augmented_cross_attn: ### self.t2u_augmented_cross_attn None in streamspeech
