...
PRETRAIN_ROOT=/gscratch/intelligentsystems/tuochao/StreamSpeech/pretrain_models
...
file=/gscratch/intelligentsystems/tuochao/StreamSpeech/checkpoints/streamspeech.simul-s2st.fr-en/checkpoint_25_41000.pt
...
PYTHONPATH=$ROOT/fairseq simuleval --data-bin ${DATA_ROOT}/${LANG}-en/fbank2unit \
    ...
    --source /gscratch/intelligentsystems/tuochao/StreamSpeech/example/wav_list.txt \
    --target /gscratch/intelligentsystems/tuochao/StreamSpeech/example/target.txt \
    --model-path $file \
